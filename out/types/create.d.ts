import { Node, ContainerNode, TextNode, CDataNode, Element, AttributeValues, AttributeDefinition } from './types';
/**
 ...
 */
export declare function createElement(name: string, childNodes?: Node[] | undefined, attributes?: AttributeValues | AttributeDefinition[]): Element;
